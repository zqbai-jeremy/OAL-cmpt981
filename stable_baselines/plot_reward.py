...
methods = ['PROJ', 'MWAL', 'FWAS', 'OAL']#, 'GAIL'
...
data = np.genfromtxt(data_paths['FWAS'], delimiter=',')
rewards = data[1:, 0]
...
plt.plot(steps, np.zeros_like(steps) + gt_reward, c='black', linestyle='--', label='Expert')
...
plt.title(env_name + ': True Reward vs. Log Number of Policy Updates', fontsize=13.5)
plt.tight_layout()
